...
{
	public var scoreShit(default, set):Float = 0;

	public var scoreStart:Float = 0;

	function set_scoreShit(val):Float
	{
	...
	{
		for (i in group.members.length-Std.int(scoreStart)...group.members.length)
		{
	...
	public function new(x:Float, y:Float, digitCount:Int, scoreShit:Float = 100)
	{
		super(x, y);
